...
const IconEmail = () => (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 39C30.4934 39 39 30.4934 39 20C39 9.50659 30.4934 1 20 1C9.50659 1 1 9.50659 1 20C1 30.4934 9.50659 39 20 39Z" stroke="currentColor" strokeWidth="2"/>
          ...
          <div className="nav__mobile-contact">
            <div className="nav__mobile-socials">
              <a
                ...
                className="nav__mobile-social-btn"
                aria-label="Email"
              >
                <IconEmail />
              </a>
